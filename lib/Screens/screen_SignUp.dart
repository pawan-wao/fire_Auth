...
import 'package:store_project/Screens/screen_HomePage.dart';
import 'package:store_project/Screens/screen_SignIn.dart';
import 'package:store_project/Widgets/widget_textarea.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Form(
                      ...
                      child: Column(
                        children: [
                          TextArea(controller: nameController, icon: Icon(Icons.person), label: 'Full Name'),
                          SizedBox(height: 15,),
